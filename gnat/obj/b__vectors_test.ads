...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_vectors_test" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d518f9b0#;
   pragma Export (C, u00001, "vectors_testB");
   ...
   u00050 : constant Version_32 := 16#84ad4a42#;
   pragma Export (C, u00050, "ada__numericsS");
   u00051 : constant Version_32 := 16#03e83d1c#;
   pragma Export (C, u00051, "ada__numerics__elementary_functionsB");
   u00052 : constant Version_32 := 16#00443200#;
   pragma Export (C, u00052, "ada__numerics__elementary_functionsS");
   u00053 : constant Version_32 := 16#3e0cf54d#;
   pragma Export (C, u00053, "ada__numerics__auxB");
   u00054 : constant Version_32 := 16#9f6e24ed#;
   pragma Export (C, u00054, "ada__numerics__auxS");
   u00055 : constant Version_32 := 16#c7bf9154#;
   pragma Export (C, u00055, "system__fat_llfS");
   u00056 : constant Version_32 := 16#f7ae5624#;
   pragma Export (C, u00056, "system__unsigned_typesS");
   u00057 : constant Version_32 := 16#cc935169#;
   pragma Export (C, u00057, "system__machine_codeS");
   u00058 : constant Version_32 := 16#6c05c057#;
   pragma Export (C, u00058, "system__exn_llfB");
   u00059 : constant Version_32 := 16#7f56917b#;
   pragma Export (C, u00059, "system__exn_llfS");
   u00060 : constant Version_32 := 16#9b5d36b3#;
   pragma Export (C, u00060, "system__fat_fltS");
   u00061 : constant Version_32 := 16#920eada5#;
   pragma Export (C, u00061, "ada__tagsB");
   u00062 : constant Version_32 := 16#13ca27f3#;
   pragma Export (C, u00062, "ada__tagsS");
   u00063 : constant Version_32 := 16#c3335bfd#;
   pragma Export (C, u00063, "system__htableB");
   u00064 : constant Version_32 := 16#47ea994d#;
   pragma Export (C, u00064, "system__htableS");
   u00065 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00065, "system__string_hashB");
   u00066 : constant Version_32 := 16#e5b4f233#;
   pragma Export (C, u00066, "system__string_hashS");
   u00067 : constant Version_32 := 16#afdbf393#;
   pragma Export (C, u00067, "system__val_lluB");
   u00068 : constant Version_32 := 16#8d5c0156#;
   pragma Export (C, u00068, "system__val_lluS");
   u00069 : constant Version_32 := 16#27b600b2#;
   pragma Export (C, u00069, "system__val_utilB");
   u00070 : constant Version_32 := 16#6f889c59#;
   pragma Export (C, u00070, "system__val_utilS");
   u00071 : constant Version_32 := 16#d1060688#;
   pragma Export (C, u00071, "system__case_utilB");
   u00072 : constant Version_32 := 16#e7214370#;
   pragma Export (C, u00072, "system__case_utilS");
   u00073 : constant Version_32 := 16#d5bfa9f3#;
   pragma Export (C, u00073, "ada__text_ioB");
   u00074 : constant Version_32 := 16#2d7da68a#;
   pragma Export (C, u00074, "ada__text_ioS");
   u00075 : constant Version_32 := 16#10558b11#;
   pragma Export (C, u00075, "ada__streamsB");
   u00076 : constant Version_32 := 16#2e6701ab#;
   pragma Export (C, u00076, "ada__streamsS");
   u00077 : constant Version_32 := 16#db5c917c#;
   pragma Export (C, u00077, "ada__io_exceptionsS");
   u00078 : constant Version_32 := 16#84a27f0d#;
   ...
   u00081 : constant Version_32 := 16#b29d05bd#;
   pragma Export (C, u00081, "system__file_ioB");
   u00082 : constant Version_32 := 16#6459cbc2#;
   pragma Export (C, u00082, "system__file_ioS");
   u00083 : constant Version_32 := 16#cf417de3#;
   ...
   u00085 : constant Version_32 := 16#8cda5937#;
   ...
   u00094 : constant Version_32 := 16#c8587602#;
   pragma Export (C, u00094, "system__concat_3S");
   u00095 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00095, "system__concat_2B");
   u00096 : constant Version_32 := 16#c188fd77#;
   pragma Export (C, u00096, "system__concat_2S");
   u00097 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00097, "system__concat_4B");
   u00098 : constant Version_32 := 16#bd4c0187#;
   pragma Export (C, u00098, "system__concat_4S");
   u00099 : constant Version_32 := 16#c80d70ed#;
   pragma Export (C, u00099, "vectorsB");
   u00100 : constant Version_32 := 16#4315d79c#;
   pragma Export (C, u00100, "vectorsS");
   u00101 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00101, "ada__float_text_ioB");
   u00102 : constant Version_32 := 16#e61b3c6c#;
   pragma Export (C, u00102, "ada__float_text_ioS");
   u00103 : constant Version_32 := 16#d5f9759f#;
   pragma Export (C, u00103, "ada__text_io__float_auxB");
   u00104 : constant Version_32 := 16#f854caf5#;
   pragma Export (C, u00104, "ada__text_io__float_auxS");
   u00105 : constant Version_32 := 16#181dc502#;
   pragma Export (C, u00105, "ada__text_io__generic_auxB");
   u00106 : constant Version_32 := 16#a6c327d3#;
   pragma Export (C, u00106, "ada__text_io__generic_auxS");
   u00107 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00107, "system__img_realB");
   u00108 : constant Version_32 := 16#04807b45#;
   pragma Export (C, u00108, "system__img_realS");
   u00109 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00109, "system__float_controlB");
   u00110 : constant Version_32 := 16#23d4699b#;
   pragma Export (C, u00110, "system__float_controlS");
   u00111 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00111, "system__img_lluB");
   u00112 : constant Version_32 := 16#be6756e7#;
   pragma Export (C, u00112, "system__img_lluS");
   u00113 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00113, "system__img_unsB");
   u00114 : constant Version_32 := 16#685a6ad3#;
   pragma Export (C, u00114, "system__img_unsS");
   u00115 : constant Version_32 := 16#93584cd0#;
   pragma Export (C, u00115, "system__powten_tableS");
   u00116 : constant Version_32 := 16#faa9a7b2#;
   pragma Export (C, u00116, "system__val_realB");
   u00117 : constant Version_32 := 16#3d015db6#;
   pragma Export (C, u00117, "system__val_realS");
   u00118 : constant Version_32 := 16#52f1910f#;
   pragma Export (C, u00118, "system__assertionsB");
   u00119 : constant Version_32 := 16#0ea50633#;
   pragma Export (C, u00119, "system__assertionsS");
   u00120 : constant Version_32 := 16#a6359005#;
   pragma Export (C, u00120, "system__memoryB");
   u00121 : constant Version_32 := 16#9a554c93#;
