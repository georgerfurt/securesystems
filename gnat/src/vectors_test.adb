...
procedure vectors_test is
   ...
   package body Driver_Internals is
      ...
      begin
         return Test_Case_Path (1 .. Test_Case_Path_Length);
      end Taken_Path;
   ...
   begin  -- test case
      ...
      begin  -- result part
         if Driver_Internals.Path_Was ("=>") then
            if abs (Actual.X - Expected.X) < 0.000001
              and then abs (Actual.Y - Expected.Y) < 0.000001
              and then abs (Actual.Z - Expected.Z) < 0.000001
            then
         ...
         when E : others =>
            ...
            Put_Line
              ("ERROR: exception " &
               ...
               " raised in result part of test case 1.");
      ...
      exception
         ...
         when E : others =>
            ...
            Put_Line
              ("ERROR: exception " &
               Ada.Exceptions.Exception_Name (E) &
               " raised in result part of test case 2.");
            raise Driver_Internals.Program_Terminate;
      end;  -- result part
   end;  -- test case
      ...
      exception
         ...
         when E : others =>
            ...
            Put_Line
              ("ERROR: exception " &
               Ada.Exceptions.Exception_Name (E) &
               " raised in result part of test case 4.");
            raise Driver_Internals.Program_Terminate;
      end;  -- result part
   end;  -- test case
      ...
      exception
         ...
         when E : others =>
            ...
            Put_Line
              ("ERROR: exception " &
               Ada.Exceptions.Exception_Name (E) &
               " raised in result part of test case 5.");
            raise Driver_Internals.Program_Terminate;
      end;  -- result part
   end;  -- test case
      ...
      exception
         ...
         when E : others =>
            ...
            Put_Line
              ("ERROR: exception " &
               Ada.Exceptions.Exception_Name (E) &
               " raised in result part of test case 6.");
            raise Driver_Internals.Program_Terminate;
      end;  -- result part
   end;  -- test case
      ...
      exception
         ...
         when E : others =>
            ...
            Put_Line
              ("ERROR: exception " &
               Ada.Exceptions.Exception_Name (E) &
               " raised in result part of test case 7.");
            raise Driver_Internals.Program_Terminate;
      end;  -- result part
   end;  -- test case
      ...
      exception
         ...
         when E : others =>
            ...
            Put_Line
              ("ERROR: exception " &
               Ada.Exceptions.Exception_Name (E) &
               " raised in result part of test case 8.");
            raise Driver_Internals.Program_Terminate;
      end;  -- result part
   end;  -- test case
      ...
      exception
         ...
         when E : others =>
            ...
            Put_Line
              ("ERROR: exception " &
               Ada.Exceptions.Exception_Name (E) &
               " raised in result part of test case 9.");
            raise Driver_Internals.Program_Terminate;
      end;  -- result part
   end;  -- test case
...
exception
   when Driver_Internals.Program_Terminate =>
      ...
      if Driver_Internals.Unexpected_Error then
         Put_Line (",");
         Put_Line
           ("        there were one or more errors outside of test cases.");
         Driver_Internals.Status := -1;
      else
         Put_Line (".");
      end if;
