...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_box_dimensions" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b7bb3b40#;
   pragma Export (C, u00001, "box_dimensionsB");
   ...
   u00124 : constant Version_32 := 16#ee101ba4#;
   pragma Export (C, u00124, "system__memoryB");
   u00125 : constant Version_32 := 16#74d8f60c#;
